const { NftFactory, Nft, ProviderInstance, Datatoken, getHash, Aquarius, downloadFile } = require("@oceanprotocol/lib");
...
createDataNftWithFixedPrice().then(({ nftAddress, datatokenAddress, fixedPrice }) => {
