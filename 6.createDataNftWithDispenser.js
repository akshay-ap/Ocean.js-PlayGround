const { NftFactory, Nft, ProviderInstance, Datatoken, getHash, Aquarius, ZERO_ADDRESS } = require("@oceanprotocol/lib");
...
createDataNftWithDispenser().then(({ nftAddress, datatokenAddress, dispenserAddress }) => {
